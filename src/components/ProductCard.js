    ...
    return (
      ...
      >
        <div className='card-ele'>
            ...
            {!this.context.toglleMiniCart && this.props.inStock && this.state.hovered && <img key={this.props.product.id} onClick={()=>{this.context.handleCartItem(this.props.product)}} className='add-to-cart' src="CircleIcon.svg" alt="" />}
      {!this.context.toglleMiniCart && this.props.inStock ? <Link style={{ textDecoration: 'none'}} to={this.props.product.id}>
